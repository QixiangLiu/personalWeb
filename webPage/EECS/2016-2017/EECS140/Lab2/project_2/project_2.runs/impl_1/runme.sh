...
HD_PWD='H:/EECS140_Lab/Lab2/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_Liu.vdi -applog -m64 -messageDb vivado.pb -mode batch -source lab2_Liu.tcl -notrace
