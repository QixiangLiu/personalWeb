...
HD_PWD='H:/EECS140_Lab/Lab2/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_Liu.vds -m64 -mode batch -messageDb vivado.pb -notrace -source lab2_Liu.tcl
