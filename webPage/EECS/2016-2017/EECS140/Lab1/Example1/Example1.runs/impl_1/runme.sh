...
HD_PWD='H:/EECS140_Lab/Lab1/Example1/Example1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Liu_lab1.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Liu_lab1.tcl -notrace
