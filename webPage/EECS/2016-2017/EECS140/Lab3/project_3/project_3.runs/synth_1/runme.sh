...
HD_PWD='H:/EECS140_Lab/Lab3/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_Liu.vds -m64 -mode batch -messageDb vivado.pb -notrace -source lab3_Liu.tcl
