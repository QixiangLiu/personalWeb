...
HD_PWD='H:/EECS140_Lab/Lab3/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab3_Liu.vdi -applog -m64 -messageDb vivado.pb -mode batch -source lab3_Liu.tcl -notrace
