...
HD_PWD='H:/EECS140_Lab/Lab7/Structural_VHDL_models/Structural_VHDL_models.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_xor6_gate.vds -m64 -mode batch -messageDb vivado.pb -notrace -source my_xor6_gate.tcl
