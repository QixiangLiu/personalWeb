...
HD_PWD='H:/EECS140_Lab/Lab7/Structural_VHDL_models/Structural_VHDL_models.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log my_xor6_gate.vdi -applog -m64 -messageDb vivado.pb -mode batch -source my_xor6_gate.tcl -notrace
