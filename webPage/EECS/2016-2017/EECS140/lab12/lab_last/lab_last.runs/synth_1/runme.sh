...
HD_PWD='H:/EECS140_Lab/lab12/lab_last/lab_last.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log liu_encoder.vds -m64 -mode batch -messageDb vivado.pb -notrace -source liu_encoder.tcl
