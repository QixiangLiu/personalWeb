...
HD_PWD='H:/EECS140_Lab/lab12/lab_last/lab_last.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log liu_encoder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source liu_encoder.tcl -notrace
