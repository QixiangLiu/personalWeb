...
;* Date/Time created: Wed Oct 04 14:37:10 2017                                *
;******************************************************************************
...
$C$DW$6	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$6, DW_AT_decl_file("H:/EECS_388/TI_ARM_Projects/Program_PushButton/Drivers/uartstdio.h")
...
;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\q709l816\\AppData\\Local\\Temp\\0824812 
	.sect	".text"
	.clink
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 42,column 2,is_stmt,isa 1
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |42| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |42| 
        CBNZ      A1, ||$C$L1||         ; [] 
        ; BRANCHCC OCCURS {||$C$L1||}    ; [] |42| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 52,column 6,is_stmt,isa 1
...
$C$DW$10	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 53,column 6,is_stmt,isa 1
...
$C$DW$11	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 54,column 6,is_stmt,isa 1
...
$C$DW$12	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 59,column 6,is_stmt,isa 1
...
$C$DW$13	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Drivers/UARTStdio_Initialization.c",line 61,column 3,is_stmt,isa 1
