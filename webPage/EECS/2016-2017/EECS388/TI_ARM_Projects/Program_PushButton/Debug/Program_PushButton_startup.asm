...
;* Date/Time created: Wed Oct 04 14:28:08 2017                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../Program_PushButton_startup.c")
...
$C$DW$1	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$1, DW_AT_decl_file("../Program_PushButton_startup.c")
...
$C$DW$2	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$2, DW_AT_decl_file("../Program_PushButton_startup.c")
...
$C$DW$3	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$3, DW_AT_decl_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$3, DW_AT_decl_line(0x43)
	.dwattr $C$DW$3, DW_AT_decl_column(0x0f)

;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\q709l816\\AppData\\Local\\Temp\\0483612 
	.sect	".text"
	.clink
	.thumbfunc ResetISR
	.thumb
...
$C$DW$4	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$4, DW_AT_TI_begin_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$4, DW_AT_TI_begin_line(0x8f)
	.dwattr $C$DW$4, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$4, DW_AT_decl_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$4, DW_AT_decl_line(0x8f)
	.dwattr $C$DW$4, DW_AT_decl_column(0x01)
	.dwattr $C$DW$4, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../Program_PushButton_startup.c",line 144,column 1,is_stmt,address ResetISR,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../Program_PushButton_startup.c",line 149,column 5,is_stmt,isa 1
    .global _c_int00
    b.w     _c_int00
	.dwpsn	file "../Program_PushButton_startup.c",line 151,column 1,is_stmt,isa 1
$C$DW$5	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$5, DW_AT_TI_return
        ...
        BX        LR                    ; [DPU_3_PIPE] 
        ; BRANCH OCCURS                  ; [] 
	.dwattr $C$DW$4, DW_AT_TI_end_file("../Program_PushButton_startup.c")
...
$C$DW$6	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$6, DW_AT_TI_begin_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$6, DW_AT_TI_begin_line(0xa1)
	.dwattr $C$DW$6, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$6, DW_AT_decl_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$6, DW_AT_decl_line(0xa1)
	.dwattr $C$DW$6, DW_AT_decl_column(0x01)
	.dwattr $C$DW$6, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../Program_PushButton_startup.c",line 162,column 1,is_stmt,address NmiSR,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../Program_PushButton_startup.c",line 166,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L1||
;*
...
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$6, DW_AT_TI_end_file("../Program_PushButton_startup.c")
...
$C$DW$7	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$7, DW_AT_TI_begin_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$7, DW_AT_TI_begin_line(0xb3)
	.dwattr $C$DW$7, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$7, DW_AT_decl_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$7, DW_AT_decl_line(0xb3)
	.dwattr $C$DW$7, DW_AT_decl_column(0x01)
	.dwattr $C$DW$7, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../Program_PushButton_startup.c",line 180,column 1,is_stmt,address FaultISR,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../Program_PushButton_startup.c",line 184,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L2||
;*
...
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$7, DW_AT_TI_end_file("../Program_PushButton_startup.c")
...
$C$DW$8	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$8, DW_AT_TI_begin_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$8, DW_AT_TI_begin_line(0xc5)
	.dwattr $C$DW$8, DW_AT_TI_begin_column(0x01)
	.dwattr $C$DW$8, DW_AT_decl_file("../Program_PushButton_startup.c")
	.dwattr $C$DW$8, DW_AT_decl_line(0xc5)
	.dwattr $C$DW$8, DW_AT_decl_column(0x01)
	.dwattr $C$DW$8, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../Program_PushButton_startup.c",line 198,column 1,is_stmt,address IntDefaultHandler,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../Program_PushButton_startup.c",line 202,column 11,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L3||
;*
...
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$8, DW_AT_TI_end_file("../Program_PushButton_startup.c")
