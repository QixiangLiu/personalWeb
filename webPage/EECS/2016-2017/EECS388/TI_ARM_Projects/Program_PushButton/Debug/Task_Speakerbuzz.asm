...
;* Date/Time created: Tue Oct 10 14:36:28 2017                                *
;******************************************************************************
...
$C$DW$19	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$19, DW_AT_decl_line(0x2d)
...
;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\q709l816\\AppData\\Local\\Temp\\1528412 
	.sect	".text"
	.clink
...
$C$DW$24	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 59,column 32,is_stmt,address Task_Speakerbuzz,isa 1
...
$C$DW$25	.dwtag  DW_TAG_variable
	.dwattr $C$DW$25, DW_AT_name("Speakerbuzz_Data")
	.dwattr $C$DW$25, DW_AT_TI_symbol_name("Speakerbuzz_Data")
	.dwattr $C$DW$25, DW_AT_type(*$C$DW$T$47)
	.dwattr $C$DW$25, DW_AT_location[DW_OP_breg13 0]

	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 61,column 28,is_stmt,isa 1
        MOVS      A1, #0                ; [DPU_3_PIPE] |61| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |61| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 63,column 2,is_stmt,isa 1
        LDR       A1, $C$CON1           ; [DPU_3_PIPE] |63| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |63| 
        CBNZ      A1, ||$C$L1||         ; [] 
        ; BRANCHCC OCCURS {||$C$L1||}    ; [] |63| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 67,column 6,is_stmt,isa 1
...
$C$DW$26	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 72,column 6,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |72| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |72| 
$C$DW$27	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$27, DW_AT_low_pc(0x00)
	.dwattr $C$DW$27, DW_AT_name("GPIOPinTypeGPIOOutput")
	.dwattr $C$DW$27, DW_AT_TI_call

        BL        GPIOPinTypeGPIOOutput ; [DPU_3_PIPE] |72| 
        ; CALL OCCURS {GPIOPinTypeGPIOOutput }  ; [] |72| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 73,column 6,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |73| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |73| 
        MOVS      A3, #1                ; [DPU_3_PIPE] |73| 
        MOVS      A4, #8                ; [DPU_3_PIPE] |73| 
$C$DW$28	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$28, DW_AT_low_pc(0x00)
	.dwattr $C$DW$28, DW_AT_name("GPIOPadConfigSet")
	.dwattr $C$DW$28, DW_AT_TI_call

        BL        GPIOPadConfigSet      ; [DPU_3_PIPE] |73| 
        ; CALL OCCURS {GPIOPadConfigSet }  ; [] |73| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 75,column 6,is_stmt,isa 1
...
$C$DW$29	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$29, DW_AT_TI_call
        ...
        BL        GPIOPinWrite          ; [DPU_3_PIPE] |75| 
        ; CALL OCCURS {GPIOPinWrite }    ; [] |75| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 80,column 6,is_stmt,isa 1
        ...
        MOV       A3, #880              ; [DPU_3_PIPE] |80| 
        UDIV      A1, A1, A3            ; [DPU_3_PIPE] |80| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |80| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 81,column 6,is_stmt,isa 1
        LDR       A2, $C$CON7           ; [DPU_3_PIPE] |81| 
        LDR       A1, $C$CON4           ; [DPU_3_PIPE] |81| 
        LDR       A3, [A2, #0]          ; [DPU_3_PIPE] |81| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |81| 
        LDR       A2, $C$CON6           ; [DPU_3_PIPE] |81| 
        ADDS      A1, A1, A3            ; [DPU_3_PIPE] |81| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |81| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 82,column 6,is_stmt,isa 1
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |82| 
        MOVS      A1, #1                ; [DPU_3_PIPE] |82| 
        STRB      A1, [A2, #0]          ; [DPU_3_PIPE] |82| 
;* --------------------------------------------------------------------------*
||$C$L1||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 92,column 2,is_stmt,isa 1
        LDR       A1, $C$CON6           ; [DPU_3_PIPE] |92| 
        LDR       A2, $C$CON7           ; [DPU_3_PIPE] |92| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |92| 
        LDR       A2, [A2, #0]          ; [DPU_3_PIPE] |92| 
        CMP       A1, A2                ; [DPU_3_PIPE] |92| 
        BHI       ||$C$L3||             ; [DPU_3_PIPE] |92| 
        ; BRANCHCC OCCURS {||$C$L3||}    ; [] |92| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 94,column 3,is_stmt,isa 1
        LDR       A1, $C$CON8           ; [DPU_3_PIPE] |94| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |94| 
        CMP       A1, #1                ; [DPU_3_PIPE] |94| 
        BNE       ||$C$L2||             ; [DPU_3_PIPE] |94| 
        ; BRANCHCC OCCURS {||$C$L2||}    ; [] |94| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 95,column 4,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |95| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |95| 
$C$DW$30	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 96,column 4,is_stmt,isa 1
        LDR       A1, [SP, #0]          ; [DPU_3_PIPE] |96| 
        EOR       A1, A1, #3            ; [DPU_3_PIPE] |96| 
        STR       A1, [SP, #0]          ; [DPU_3_PIPE] |96| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 97,column 4,is_stmt,isa 1
        LDR       A1, $C$CON3           ; [DPU_3_PIPE] |97| 
        LDRB      A3, [SP, #0]          ; [DPU_3_PIPE] |97| 
        MOVS      A2, #3                ; [DPU_3_PIPE] |97| 
...
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 103,column 9,is_stmt,isa 1
        LDR       A2, $C$CON7           ; [DPU_3_PIPE] |103| 
        LDR       A1, $C$CON4           ; [DPU_3_PIPE] |103| 
        LDR       A3, [A2, #0]          ; [DPU_3_PIPE] |103| 
        LDR       A1, [A1, #0]          ; [DPU_3_PIPE] |103| 
        LDR       A2, $C$CON6           ; [DPU_3_PIPE] |103| 
        ADDS      A1, A1, A3            ; [DPU_3_PIPE] |103| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |103| 
	.dwpsn	file "../Tasks/Task_Speakerbuzz.c",line 106,column 1,is_stmt,isa 1
;* --------------------------------------------------------------------------*
||$C$L3||:    
