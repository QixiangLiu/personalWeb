...
;* Date/Time created: Wed Sep 20 15:09:13 2017                                *
;******************************************************************************
...
$C$DW$15	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$15, DW_AT_decl_file("../Program_Speakerbuzz.c")
...
$C$DW$16	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$16, DW_AT_decl_file("../Program_Speakerbuzz.c")
...
$C$DW$17	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$17, DW_AT_decl_file("../Program_Speakerbuzz.c")
...
$C$DW$18	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$18, DW_AT_decl_file("../Program_Speakerbuzz.c")
...
$C$DW$19	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$19, DW_AT_decl_file("../Program_Speakerbuzz.c")
...
$C$DW$20	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$20, DW_AT_decl_file("../Program_Speakerbuzz.c")
...
$C$DW$21	.dwtag  DW_TAG_variable
	...
	.dwattr $C$DW$21, DW_AT_decl_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$21, DW_AT_decl_line(0x61)
	.dwattr $C$DW$21, DW_AT_decl_column(0x06)

;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\q709l816\\AppData\\Local\\Temp\\4022012 
	.sect	".text"
	.clink
...
$C$DW$22	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$22, DW_AT_TI_begin_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$22, DW_AT_TI_begin_line(0x51)
	.dwattr $C$DW$22, DW_AT_TI_begin_column(0x0d)
	.dwattr $C$DW$22, DW_AT_decl_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$22, DW_AT_decl_line(0x51)
	.dwattr $C$DW$22, DW_AT_decl_column(0x0d)
	.dwattr $C$DW$22, DW_AT_TI_max_frame_size(0x00)
	.dwpsn	file "../Program_Speakerbuzz.c",line 81,column 37,is_stmt,address SysTickIntHandler,isa 1
...
;* --------------------------------------------------------------------------*
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../Program_Speakerbuzz.c",line 87,column 2,is_stmt,isa 1
        LDR       A2, $C$CON1           ; [DPU_3_PIPE] |87| 
        LDR       A1, [A2, #0]          ; [DPU_3_PIPE] |87| 
        ADDS      A1, A1, #1            ; [DPU_3_PIPE] |87| 
        STR       A1, [A2, #0]          ; [DPU_3_PIPE] |87| 
	.dwpsn	file "../Program_Speakerbuzz.c",line 89,column 1,is_stmt,isa 1
$C$DW$23	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$23, DW_AT_TI_return
        ...
        BX        LR                    ; [DPU_3_PIPE] 
        ; BRANCH OCCURS                  ; [] 
	.dwattr $C$DW$22, DW_AT_TI_end_file("../Program_Speakerbuzz.c")
...
$C$DW$24	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$24, DW_AT_TI_begin_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$24, DW_AT_TI_begin_line(0x63)
	.dwattr $C$DW$24, DW_AT_TI_begin_column(0x0d)
	.dwattr $C$DW$24, DW_AT_decl_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$24, DW_AT_decl_line(0x63)
	.dwattr $C$DW$24, DW_AT_decl_column(0x0d)
	.dwattr $C$DW$24, DW_AT_TI_max_frame_size(0x08)
	.dwpsn	file "../Program_Speakerbuzz.c",line 99,column 31,is_stmt,address Initialize_OLED,isa 1
...
;* --------------------------------------------------------------------------*
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 101,column 2,is_stmt,isa 1
        LDR       A1, $C$CON2           ; [DPU_3_PIPE] |101| 
        LDRB      A1, [A1, #0]          ; [DPU_3_PIPE] |101| 
        CBNZ      A1, ||$C$L1||         ; [] 
        ; BRANCHCC OCCURS {||$C$L1||}    ; [] |101| 
;* --------------------------------------------------------------------------*
	.dwpsn	file "../Program_Speakerbuzz.c",line 105,column 3,is_stmt,isa 1
...
$C$DW$25	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 106,column 3,is_stmt,isa 1
...
$C$DW$26	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 108,column 3,is_stmt,isa 1
        LDR       A2, $C$CON2           ; [DPU_3_PIPE] |108| 
        MOVS      A1, #1                ; [DPU_3_PIPE] |108| 
        STRB      A1, [A2, #0]          ; [DPU_3_PIPE] |108| 
	.dwpsn	file "../Program_Speakerbuzz.c",line 111,column 1,is_stmt,isa 1
;* --------------------------------------------------------------------------*
||$C$L1||:    
$C$DW$27	.dwtag  DW_TAG_TI_branch
	...
	.dwcfi	cfa_offset, 0
        ; BRANCH OCCURS                  ; [] 
	.dwattr $C$DW$24, DW_AT_TI_end_file("../Program_Speakerbuzz.c")
...
$C$DW$28	.dwtag  DW_TAG_subprogram
	...
	.dwattr $C$DW$28, DW_AT_TI_begin_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$28, DW_AT_TI_begin_line(0x79)
	.dwattr $C$DW$28, DW_AT_TI_begin_column(0x05)
	.dwattr $C$DW$28, DW_AT_decl_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$28, DW_AT_decl_line(0x79)
	.dwattr $C$DW$28, DW_AT_decl_column(0x05)
	.dwattr $C$DW$28, DW_AT_TI_max_frame_size(0x08)
	.dwpsn	file "../Program_Speakerbuzz.c",line 121,column 19,is_stmt,address main,isa 1
...
$C$DW$29	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 132,column 2,is_stmt,isa 1
$C$DW$30	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 137,column 5,is_stmt,isa 1
...
$C$DW$31	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 138,column 5,is_stmt,isa 1
$C$DW$32	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 139,column 5,is_stmt,isa 1
$C$DW$33	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Program_Speakerbuzz.c",line 145,column 13,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L2||
;*
...
;* --------------------------------------------------------------------------*
||$C$L2||:    
	.dwpsn	file "../Program_Speakerbuzz.c",line 146,column 6,is_stmt,isa 1
$C$DW$34	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$34, DW_AT_low_pc(0x00)
	.dwattr $C$DW$34, DW_AT_name("Task_LEDBlink")
	.dwattr $C$DW$34, DW_AT_TI_call

        BL        Task_LEDBlink         ; [DPU_3_PIPE] |146| 
        ; CALL OCCURS {Task_LEDBlink }   ; [] |146| 
	.dwpsn	file "../Program_Speakerbuzz.c",line 147,column 6,is_stmt,isa 1
$C$DW$35	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$35, DW_AT_low_pc(0x00)
	.dwattr $C$DW$35, DW_AT_name("Task_ReportSysTick")
	.dwattr $C$DW$35, DW_AT_TI_call

        BL        Task_ReportSysTick    ; [DPU_3_PIPE] |147| 
        ; CALL OCCURS {Task_ReportSysTick }  ; [] |147| 
	.dwpsn	file "../Program_Speakerbuzz.c",line 148,column 6,is_stmt,isa 1
$C$DW$36	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$36, DW_AT_low_pc(0x00)
	.dwattr $C$DW$36, DW_AT_name("Task_Speakerbuzz")
	.dwattr $C$DW$36, DW_AT_TI_call

        BL        Task_Speakerbuzz      ; [DPU_3_PIPE] |148| 
        ; CALL OCCURS {Task_Speakerbuzz }  ; [] |148| 
	.dwpsn	file "../Program_Speakerbuzz.c",line 145,column 13,is_stmt,isa 1
        B         ||$C$L2||             ; [DPU_3_PIPE] |145| 
        ; BRANCH OCCURS {||$C$L2||}      ; [] |145| 
;* --------------------------------------------------------------------------*
	.dwattr $C$DW$28, DW_AT_TI_end_file("../Program_Speakerbuzz.c")
	.dwattr $C$DW$28, DW_AT_TI_end_line(0x97)
