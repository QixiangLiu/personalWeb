...
;* Date/Time created: Fri Feb 10 16:12:51 2017                                *
;******************************************************************************
...
;	C:\TI_CodeComposer\ccsv6\tools\compiler\ti-cgt-arm_15.12.1.LTS\bin\armacpia.exe -@C:\\Users\\gminden\\AppData\\Local\\Temp\\0618412 
	.sect	".text"
	.clink
	.thumbfunc main
	.thumb
...
$C$DW$21	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "../Main_Blinky.c",line 40,column 18,is_stmt,address main,isa 1
...
;* --------------------------------------------------------------------------*
	...
	.dwcfi	cfa_offset, 24
	.dwpsn	file "../Main_Blinky.c",line 45,column 5,is_stmt,isa 1
...
$C$DW$22	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Main_Blinky.c",line 51,column 2,is_stmt,isa 1
$C$DW$23	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Main_Blinky.c",line 53,column 2,is_stmt,isa 1
$C$DW$24	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Main_Blinky.c",line 58,column 2,is_stmt,isa 1
...
$C$DW$25	.dwtag  DW_TAG_TI_branch
	...
	.dwpsn	file "../Main_Blinky.c",line 60,column 2,is_stmt,isa 1
...
$C$DW$26	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$26, DW_AT_TI_call
        ...
        BL        UARTprintf            ; [DPU_3_PIPE] |60| 
        ; CALL OCCURS {UARTprintf }      ; [] |60| 
...
$C$DW$27	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$27, DW_AT_TI_call
        ...
        BL        vTaskStartScheduler   ; [DPU_3_PIPE] |65| 
        ; CALL OCCURS {vTaskStartScheduler }  ; [] |65| 
	.dwpsn	file "../Main_Blinky.c",line 67,column 10,is_stmt,isa 1
;* --------------------------------------------------------------------------*
;*   BEGIN LOOP ||$C$L1||
;*
;*   Loop source line                : 67
...
;* --------------------------------------------------------------------------*
||$C$L1||:    
        B         ||$C$L1||             ; [DPU_3_PIPE] |67| 
        ; BRANCH OCCURS {||$C$L1||}      ; [] |67| 
;* --------------------------------------------------------------------------*
