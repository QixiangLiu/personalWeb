...
MAIN Function here!
04/20/19
// MAIN ->parse_file --> parse_command --> 1)parse_alloc -->buddy_alloc-->buddy_dump  OR 2)parse_free --> buddy_free
...
int main(int argc, char** argv)
{
	...
	// Execute program
	buddy_init();
	prog_status = parse_file(); // parse_file --> parse_command --> 1)parse_alloc -->buddy_alloc-->buddy_dump  2)parse_free --> buddy_free
