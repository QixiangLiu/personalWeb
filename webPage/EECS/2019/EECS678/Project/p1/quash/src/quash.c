...
//This code is for macbook to define HOST_NAME_MAX
...
static void print_prompt() {
  bool should_free = true; //if free();space
...
int main(int argc, char** argv) {
  ...
  while (is_running()) {
    ...
    CommandHolder* script = parse(&state); // parse or read input command
    // printf();
    if (script != NULL)
      run_script(script); //the first execute
