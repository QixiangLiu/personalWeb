 ...
 */
 //declare a data structe name called pid_queue .h
// #ifndef IMPLEMENT_DEQUE_STRUCT(pid_queue,int);
// #define IMPLEMENT_DEQUE_STRUCT(pid_queue,int);
// #endif
// #ifndef PROTOTYPE_DEQUE (pid_queue, int);
// #define PROTOTYPE_DEQUE (pid_queue, int);
// #endif
//
// //struct_name called job_queue type is job!   .h
// #ifndef IMPLEMENT_DEQUE_STRUCT(job_queue,job);
// #define IMPLEMENT_DEQUE_STRUCT(job_queue,job);
// #endif
// #ifndef PROTOTYPE_DEQUE (job_queue, job);
// #define PROTOTYPE_DEQUE (job_queue, job);
// #endif
