...
bool CallExpNode::nameAnalysis(SymbolTable* symTab){
	...
	myId->setKind("fnCall");
	bool flag1=myId->nameAnalysis(symTab);
	bool flag2=myExpList->nameAnalysis(symTab);
	return flag1&&flag2;
}
...
bool PlusNode::nameAnalysis(SymbolTable* symTab){
	bool flag1=myExp1->nameAnalysis(symTab);
	bool flag2=myExp2->nameAnalysis(symTab);
	return flag1&&flag2;
...
bool IfStmtNode::nameAnalysis(SymbolTable* symTab){
	...
	bool flag1=myExp->nameAnalysis(symTab);
	symTab->openScope("if");
	bool flag2=myDecls->nameAnalysis(symTab);
	bool flag3=myStmts->nameAnalysis(symTab);
	symTab->closeScope();
...
bool IfElseStmtNode::nameAnalysis(SymbolTable* symTab){
	...
	bool flag1=myExp->nameAnalysis(symTab);
	symTab->openScope("if-else");
	bool flag2=myDeclsT->nameAnalysis(symTab);
	bool flag3=myStmtsT->nameAnalysis(symTab);
	symTab->closeScope();

	symTab->openScope("if-else");
	bool flag4=myDeclsF->nameAnalysis(symTab);
	bool flag5=myStmtsF->nameAnalysis(symTab);
	symTab->closeScope();
...
std::string FormalDeclNode::getType(){return this->myType->getType();}
std::string FormalDeclNode::getId(){return this->myId->getId();}

std::string StructNode::getId(){return this->myId->getId(); }
} // End namespace LIL' C
